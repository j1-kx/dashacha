...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="insertCustomer">
      <table>
			<tr>
				...
				<td>真实姓名</td>
				<td> <input type="text" name="name" id="crealname" class="required"   /> * </td>
			</tr>
			<tr>
				...
				<td>职业</td>
				<td> <input type="text" name="career" id="uposition" /> </td>
			</tr>
			<tr>
				<td>地址</td>
